...
const bt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},At=t=>(...e)=>({_$litDirective$:t,values:e});class Et{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const St="ontouchstart"in window||navigator.maxTouchPoints>0||navigator.maxTouchPoints>0;class xt extends HTMLElement{constructor(){super(),this.holdTime=500,this.held=!1,this.ripple=document.createElement("mwc-ripple")}connectedCallback(){Object.assign(this.style,{position:"absolute",width:St?"100px":"50px",height:St?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none",zIndex:"999"}),this.appendChild(this.ripple),this.ripple.primary=!0,["touchcancel","mouseout","mouseup","touchmove","mousewheel","wheel","scroll"].forEach((t=>{document.addEventListener(t,(()=>{clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0}),{passive:!0})}))}bind(t,e){if(t.actionHandler)return;t.actionHandler=!0,t.addEventListener("contextmenu",(t=>{const e=t||window.event;return e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,!1}));const i=t=>{let e,i;this.held=!1,t.touches?(e=t.touches[0].pageX,i=t.touches[0].pageY):(e=t.pageX,i=t.pageY),this.timer=window.setTimeout((()=>{this.startAnimation(e,i),this.held=!0}),this.holdTime)},n=i=>{i.preventDefault(),["touchend","touchcancel"].includes(i.type)&&void 0===this.timer||(clearTimeout(this.timer),this.stopAnimation(),this.timer=void 0,this.held?gt(t,"action",{action:"hold"}):e.hasDoubleClick?"click"===i.type&&i.detail<2||!this.dblClickTimeout?this.dblClickTimeout=window.setTimeout((()=>{this.dblClickTimeout=void 0,gt(t,"action",{action:"tap"})}),250):(clearTimeout(this.dblClickTimeout),this.dblClickTimeout=void 0,gt(t,"action",{action:"double_tap"})):gt(t,"action",{action:"tap"}))};t.addEventListener("touchstart",i,{passive:!0}),t.addEventListener("touchend",n),t.addEventListener("touchcancel",n),t.addEventListener("mousedown",i,{passive:!0}),t.addEventListener("click",n),t.addEventListener("keyup",(t=>{13===t.keyCode&&n(t)}))}startAnimation(t,e){Object.assign(this.style,{left:`${t}px`,top:`${e}px`,display:null}),this.ripple.disabled=!1,this.ripple.active=!0,this.ripple.unbounded=!0}stopAnimation(){this.ripple.active=!1,this.ripple.disabled=!0,this.style.display="none"}}customElements.define("action-handler-nationalrail-times-card",xt);const Ct=(t,e)=>{const i=(()=>{const t=document.body;if(t.querySelector("action-handler-nationalrail-times-card"))return t.querySelector("action-handler-nationalrail-times-card");const e=document.createElement("action-handler-nationalrail-times-card");return t.appendChild(e),e})();i&&i.bind(t,e)},Tt=At(class extends Et{update(t,[e]){return Ct(t.element,e),I}render(t){}});var kt={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error",show_status:"Show Status",show_arrival_time:"Show Arrival Time",show_departure_time:"Show Departure Time",show_callingpoints:"Show Calling Points",show_via_destination:"Show Via Destination"},Pt={common:kt},Ot={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},Ut={common:Ot};const Nt={en:Object.freeze({__proto__:null,common:kt,default:Pt}),nb:Object.freeze({__proto__:null,common:Ot,default:Ut})};window.customCards=window.customCards||[],window.customCards.push({type:"nationalrail-times-card",name:"National Rail Times Card",description:"A custom template to present departure details from a configured station enabled from the National Rail Departure Times Integration"});const Rt="default",Ht="thin",Dt="success",jt="warning",Mt="error";let Lt=class extends ot{static async getConfigElement(){return await import("./editor-c6c76ac6.js"),document.createElement("nationalrail-times-card-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error(function(t,e="",i=""){const n=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let s;try{s=t.split(".").reduce(((t,e)=>t[e]),Nt[n])}catch(e){s=t.split(".").reduce(((t,e)=>t[e]),Nt.en)}return void 0===s&&(s=t.split(".").reduce(((t,e)=>t[e]),Nt.en)),""!==e&&""!==i&&(s=s.replace(e,i)),s}("common.invalid_configuration"));t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({show_theme:Rt,show_warning:!0,show_error:!0,show_via_destination:!0,show_callingpoints:!0,show_status:!0,show_arrival_time:!0,show_departure_time:!0,show_lastupdated:!0},t)}shouldUpdate(t){return!!this.config&&function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var n=e.get("hass");return!n||n.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}getEntity(t){if(this.hass&&t in this.hass.states)return this.hass.states[t]}isCancelled(t){if(!(null==t?void 0:t.service))return!0;const e=t.service.etd;return!t.calling_points||!("Cancelled"!==e&&void 0!==t.calling_points)}isDelayed(t){if(!t)return;return(t.etd||"").match(/[0-9]/i)}formatTime(t){return t.replace("_",":")}getTimeDiff(t,e){const i=new Date("2000.1.1 "+t);let n=new Date("2000.1.1 "+e);n<i&&(n=new Date("2000.1.2 "+e));return(n.getTime()-i.getTime())/1e3/60}destinationVia(t){var e,i;if((null==t?void 0:t.destination)&&(null===(e=t.destination)||void 0===e?void 0:e.location)&&(null===(i=t.destination.location)||void 0===i?void 0:i.via))return t.destination.location.via}departureTime(t){if(this.isCancelled(t))return;const e=t.service;if(!e)return;let i=e.std;return this.isDelayed(e)&&(i=e.etd),this.formatTime(i)}arrivalTime(t){if(this.isCancelled(t))return;const e=(null==t?void 0:t.calling_points)||[],i=e.length;if(i){const t=e[i-1];return this.formatTime(t.st)}}stationMessage(t){if(this.config.show_warning&&t.message){const e=t.message.replace("this station",t.station_name+" station");return z`<div class="messages">${this._showWarning(e)}</div>`}}getStatus(t){let e=Dt;return this.isCancelled(t)?e=Mt:!this.isDelayed(t)&&(null==t?void 0:t.service)||(e=jt),e}_renderServiceStatus(t,e=Rt){if(!this.config.show_status)return;const i=this.getStatus(t),n=function(t,e){return t.isDelayed(e.service)?z`Delayed (<span class="delayed">${t.formatTime(e.service.std)}</span>)`:(null==e?void 0:e.service)?e.service.etd:"Service Suspended"};return z`
    <div class="status ${i}">
      ...
      ${this._renderServiceStatus(t.attributes,Rt)}
      ${this._renderServiceTimes(t.attributes)}
      ${this._renderCallingPoints(t.attributes)}
    `}renderThinTheme(t){return z`
      <div class="title">
        <ha-icon class="title_icon ${this.getStatus(t.attributes)}" icon="mdi:bus-clock"></ha-icon>
        <div class="title_inner">
          <div class="title_inner_wrapper">
            ...
            <div class="title_inner_wrapper-status">
              ${this._renderServiceStatus(t.attributes,Ht)}
            </div>
          </div>
          ${this.config.show_via_destination?z`<div class="via-destination">${this.destinationVia(t.attributes.service)}</div>`:null}
        </div>
    ...
    `}render(){const t=this.getEntity(this.config.entity);if(console.log(t),t)return z`
      <ha-card
        @action=${this._handleAction}
        .actionHandler=${Tt({hasHold:wt(this.config.hold_action),hasDoubleClick:wt(this.config.double_tap_action)})}
        tabindex="0"
        .label=${`National Rail: ${this.config.entity||"No Entity Defined"}`}
      >
        <div class="card-content ${this.config.theme}_theme">
          ${this.config.theme==Ht?this.renderThinTheme(t):this.renderDefaultTheme(t)}
          ${this.config.show_lastupdated?z`<div class="content-footer">${this._renderLastUpdated()}</div>`:null}
        </div>
      </ha-card>
    ...
    `}};n([ct({attribute:!1})],Lt.prototype,"hass",void 0),n([dt()],Lt.prototype,"config",void 0),Lt=n([at("nationalrail-times-card")],Lt);export{Lt as N,h as S,e as _,i as a,n as b,At as c,d,ct as e,B as f,dt as g,s as h,Et as i,at as j,vt as l,gt as n,ht as o,ot as s,bt as t,I as x,z as y};
